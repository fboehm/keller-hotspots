...
nhot <- 126 # number of trans hotspot traits for this hotspot
...
readRDS("Chr11hot_nonlocal.rds") -> hotspot
readRDS("Chr11hot_local.rds") -> local

# load chr2 allele probabilities
readRDS("Chr11_aprobs.rds") -> geno # genoprobs_chr2.rds is on SQUID

# load kinship matrix (LOCO, ie, for chromosome 2, ie, doesn't use chr2 data)
readRDS("Chr11_kinship.rds") -> kinship
